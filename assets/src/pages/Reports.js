...
const Reports = () => {
	...
	useEffect(() => {
		Api.get( 'reports/order/overview' )
			.then( ( response ) => {
				...
				<div className={'wm-grid wm-grid-cols-1 md:wm-grid-cols-2 wm-gap-4'}>
					...
					<div className={'wm-grid wm-grid-cols-1 md:wm-grid-cols-2 wm-gap-4'}>
						<StatCard
							...
							value={overview?.total_order_count && overview.total_order_count}
							icon={totalOrderIcon}
						/>
					...
					<div className={'wm-card'}>
						<h1 className={'wm-text-xl wm-font-semibold'}>{__('User Report', 'we-meal')}</h1>
					</div>

					<div className={'wm-card'}>
						<div className={'wm-flex-col wm-items-center wm-justify-center'}>
							<h1 className={'wm-text-xl wm-font-semibold'}>{__('Order Overview Today', 'we-meal')}</h1>
