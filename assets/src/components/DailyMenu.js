			...
			<>
				<div className={'wm-card'}>
					<div className={'wm-flex wm-items-center wm-justify-between'}>
						...
						<div className={'wm-h-8 wm-w-24 wm-bg-slate-200 wm-rounded'}/>
					</div>

					<div className={'wm-animate-pulse wm-border-2 wm-rounded-md wm-p-4 wm-mt-4 wm-border-slate-100'}>
						<div className={'wm-h-5 wm-w-32 wm-bg-slate-200 wm-rounded'}/>
						<div className={'wm-mt-2 wm-h-2 wm-w-32 wm-bg-slate-200 wm-rounded'}/>
						<div className={'wm-mt-6 wm-h-2 wm-w-32 wm-bg-slate-200 wm-rounded'}/>
					</div>
				</div>
			</>
		);
