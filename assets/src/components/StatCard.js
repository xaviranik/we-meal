		...
		return (
			<div className={'wm-card'}>
				...
				>
					...
					<div
						className={
							'wm-mt-4 wm-flex wm-items-center wm-justify-between'
						}
					>
						<div
							className={
								'wm-h-10 wm-w-16 wm-bg-slate-200 wm-rounded'
							}
						/>
						<div
							className={
								'wm-bg-slate-200 wm-px-5 wm-py-5 wm-rounded-md'
							}
						/>
					</div>
				</div>
		...
		return (
			<div className={'wm-card'}>
				...
				>
					...
					<span
						className={
							'wm-text-gray-600 wm-text-sm wm-font-thin wm-mt-6'
						}
					>
						{subtitle}
					</span>
					...
					>
						<h1 className={'wm-font-semibold wm-text-4xl'}>
							{value}
						</h1>
						<div
							className={
								'wm-bg-indigo-100 wm-px-5 wm-py-5 wm-rounded-md'
							}
						>
							<Icon />
						</div>
